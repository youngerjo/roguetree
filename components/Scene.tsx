...
import { OrbitControls, AccumulativeShadows, RandomizedLight, Html } from '@react-three/drei'
...
export default function Scene() {
  ...
  const shadow = environment.shadow ?? { color: 'black', opacity: 0.5 }
  ...
  return (
    <>
      ...
      <Suspense fallback={null}>
        ...
        <directionalLight color={directionalLight.color} position={directionalLight.position} />
        <Ground />
        <group>
